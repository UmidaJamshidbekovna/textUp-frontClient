    ...
    <div className={styles.landing}>
      ...
      <header
        className={`${styles.header} ${
          isScrollingDown ? styles.headerTop : ""
        }`}
      >
          ...
          <div className={styles.navContent}>
            ...
            <div className={styles.desktopNav}>
              ...
              <div className={styles.contactInfo}>
                ...
                <a
                  href="https://t.me/Textupsupport24_bot"
                  className={styles.contactItem}
                  target="_blank"
                >
                  <FaTelegram />
      ...
      <section id="features" className={styles.features}>
        <div className={styles.container}>
          ...
          >
            ...
            <p>
              TextUp platformasi orqali 1-yanvarga qadar istalgan miqdordagi SMS
              xabarlarni bepul yuboring va mijozlaringiz bilan aloqani qayta
              tiklang.
            </p>
          </div>
          <div className={styles.featuresGrid}>
            ...
            >
              ...
              <p>
                Sinov davrida siz cheklanmagan miqdorda SMS yuborishingiz
                mumkin.
              </p>
            </div>
            ...
            >
              ...
              <p>
                Platformaning barcha asosiy imkoniyatlaridan to&apos;liq
                foydalanasiz. Xizmat tezligi va sifatini shaxsan sinab
                ko&apos;rasiz.
              </p>
            </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.advantagesGrid}>
            ...
            >
              ...
              <p>
                TextUp orqali yuborilgan SMS xabarlari boshqa platformalarga
                nisbatan tezroq atiga 1-2 sekundda yetib boradi. Optimizatsiya
                qilingan serverlarimiz va to&apos;g&apos;ridan-to&apos;g&apos;ri
                operatorlar bilan ulanishlar xabarlaringizni kechikishsiz
            ...
            >
              ...
              <p>
                Biz sizga eng maqul narxlarni taklif qilamiz. TextUp istalgan
                SMS platforma bilan narx bo&apos;yicha bemalol bellasha oladi.
              </p>
            </div>
            ...
            >
              ...
              <p>
                Barqaror ishlaydigan tizim, qulay boshqaruv paneli va sodda
                integratsiya — bularning barchasi SMS jarayonlarini oson
                boshqarishingiz uchun.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="developers" className={styles.codeSection}>
        <div className={styles.container}>
          ...
          <div className={styles.codeExamples}>
            <div className={styles.languageTabs} data-aos="fade-right">
              {languages.map((lang) => (
                <button
                  key={lang}
            ...
            <div
              className={styles.codeCtas}
              data-aos="zoom-in"
              data-aos-delay="200"
            >
              <button className={styles.codePrimaryBtn}>API Hujjatlari</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className={styles.pricing}>
        <div className={styles.container}>
          ...
          >
            <h2>SMS Paketlari</h2>
            <p>
              O&apos;zingizga mos SMS paketini tanlang va operatorlar bilan
              ishlang
            </p>
          </div>

          <div
            className={styles.pricingOverview}
            data-aos="fade-up"
            data-aos-delay="100"
          >
          ...
          <div className={styles.pricingCardsContainer}>
            <div
              className={styles.pricingTableCard}
              data-aos="fade-right"
              data-aos-delay="200"
            >
            ...
            <div
              className={styles.mainPackageCard}
              data-aos="fade-up"
              data-aos-delay="300"
            >
        ...
        <div className={styles.container}>
          <div className={styles.footerMain}>
            <div className={styles.footerBrand}>
              <Logo color="white" />
              <p>
                Bir necha oddiy qadamda ko&apos;plab kompaniyalar nima uchun
                bizni SMS provayderi sifatida tanlaganini bilib oling.
              </p>
            </div>
