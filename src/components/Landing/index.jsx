...
import {
    FiMenu, FiX, FiChevronDown, FiCheck, FiStar,
    FiArrowRight, FiSend
} from 'react-icons/fi'
    ...
    const features = [
        {
            ...
            description: 'Become the master of your SMS strategy by grabbing your Free SMS Playbook and achieve an astounding 98% read rate.',
        ...
        },
        {
            ...
            description: 'Increase engagement with personalized SMS automations that trigger based on customer behavior.',
        ...
        },
        {
            ...
            description: 'Attach personalized, rich content to your text messages with our prebuilt landing page templates.',
        ...
        },
        {
            ...
            description: 'Segment and retarget those most likely to purchase by analyzing data and customer behavior.',
            cta: 'Try for free'
        }
    ]
                    ...
                    {mobileMenuOpen && (
                        <div className={styles.mobileMenu}>
                            <div className={styles.mobileMenuContent}>
                                <button className={styles.mobileNavLink}>Products</button>
                                <Link href="#pricing" className={styles.mobileNavLink}>Pricing</Link>
                                <Link href="#developers" className={styles.mobileNavLink}>Developers</Link>
                                <button className={styles.mobileNavLink}>Solutions</button>
                                <button className={styles.mobileNavLink}>Resources</button>
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.codeExamples}>
                        ...
                        <div className={styles.codeCtas}>
                            <button className={styles.codePrimaryBtn}>API Documentation</button>
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.pricingCards}>
                        ...
                        <div className={styles.pricingCard}>
                            <h3>Free</h3>
                            <p>
                                Try our Free plan and start testing. Ideal for getting started and exploring all of the SMS Portal products.
                            </p>
                            ...
                            <p className={styles.priceNote}>Cancel any time. No credit card needed.</p>
                        </div>
                        ...
                        <div className={`${styles.pricingCard} ${styles.featured}`}>
                            ...
                            <h3>Standard</h3>
                            <p>
                                Choose your ideal plan or bundle size and Pay-as-you-Go. No Subscriptions, No Contracts.
                            </p>
                            <div className={styles.price}>
                            ...
                            <p className={styles.priceNote}>Excl. VAT/BST/Tax (Incl Carrier costs)</p>
                        </div>
                        ...
                        <div className={styles.pricingCard}>
                            <h3>Enterprise</h3>
                            <p>
                                High volume senders can enjoy the Enterprise plan and receive account feature benefits and VIP support.
                            </p>
                            <div className={styles.price}>
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.footerMain}>
                        ...
                        <div className={styles.footerBrand}>
                            <Logo color="white" />
                            <p>
                                In a few simple steps you can find out why over 10,000 companies choose us as their SMS provider.
                            </p>
                        ...
                        <div className={styles.footerColumn}>
                            ...
                            <ul>
                                <li><a href="#">SMS</a></li>
                                <li><a href="#">Numbers + Short Codes</a></li>
